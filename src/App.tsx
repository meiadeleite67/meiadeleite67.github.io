...
export default function App() {
  ...
  return (
    <>
      ...
      {/* A bola do canto. O rodape ja tem o mesmo botao, mas o rodape esta no
          fim da pagina: quem apanha um erro a meio de um jogo nao vai rolar
          ate la a baixo para o contar, e um erro que da trabalho a contar nao
          se conta. Fica a esquerda de proposito, que o boletim das apostas
          vive no canto da direita. */}
      <button
        className="bola-ticket"
        type="button"
        onClick={() => setAAvisar(true)}
        title="Abrir ticket: alguma coisa está partida?"
        aria-label="Abrir ticket"
      >
        <svg width="21" height="21" viewBox="0 0 24 24" aria-hidden="true">
          <path
            d="M4 5.5h16v10.5H13l-4 3.5v-3.5H4Z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.9"
            strokeLinejoin="round"
          />
          <path d="M12 8.6v3.1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
          <circle cx="12" cy="13.6" r="0.95" fill="currentColor" />
        </svg>
      </button>
